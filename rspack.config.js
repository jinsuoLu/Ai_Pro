...
process.env.VUE_APP_MOCK_ENABLE = 'false' // 禁用mock，使用独立服务器
...
module.exports = {
  ...
  plugins: [
    ...
    new DefinePlugin({
      ...
      'process.env.VUE_APP_DEPLOY_MODE': JSON.stringify(process.env.VUE_APP_DEPLOY_MODE || 'local'),
      'process.env.VUE_APP_GITHUB_REPO': JSON.stringify(process.env.VUE_APP_GITHUB_REPO || ''),
      'process.env.VUE_APP_BACKEND_URL': JSON.stringify(process.env.VUE_APP_BACKEND_URL || 'https://ai-pro-9ceb.onrender.com'),
    }),
