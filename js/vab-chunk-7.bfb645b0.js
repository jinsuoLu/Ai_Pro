...
42262: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var ScaleRawExtentInfo = /** @class */function () {
  ...
  ScaleRawExtentInfo.prototype.modifyDataMinMax = function (minMaxName, val) {
    if (true) {
      (0,zrender_lib_core_util_js__rspack_import_0.assert)(!this.frozen);
    }
...
86351: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
...
/* import */ var _axisModelCommonMixin_js__rspack_import_3 = __webpack_require__(12462);
...
76953: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
85508: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
19055: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
89737: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
      ...
      zrender_lib_core_util_js__rspack_import_0.each(creatorMap, function (creator, type) {
        ...
        if (true) {
          if (canBeNonSeriesBox) {
            ...
            zrender_lib_core_util_js__rspack_import_0.each(list, function (master) {
              return zrender_lib_core_util_js__rspack_import_0.assert(!master.update);
            });
          }
        }
      });
...
function registerLayOutOnCoordSysUsage(opt) {
  if (true) {
    zrender_lib_core_util_js__rspack_import_0.assert(!coordSysUseMap.get(opt.fullType));
  }
  ...
  if (coordSysType) {
    ...
    if (coordSysUsageOption === 'data') {
      ...
      if (!isSeries) {
        if (true) {
          if (isDeclaredExplicitly && printError) {
            (0,_util_log_js__rspack_import_1.error)('coordinateSystemUsage "data" is not supported in non-series components.');
          }
        }
      ...
      if (!isSeries && !canBeNonSeriesBoxCoordSys(coordSysType)) {
        if (true) {
          if (isDeclaredExplicitly && printError) {
            (0,_util_log_js__rspack_import_1.error)("coordinateSystem \"" + coordSysType + "\" cannot be used" + (" as coordinateSystemUsage \"box\" for \"" + model.type + "\" yet."));
          }
        }
        kind = CoordinateSystemUsageKind.none;
      }
...
function injectCoordSysByOption(opt) {
  ...
  if (true) {
    zrender_lib_core_util_js__rspack_import_0.assert(!!coordSysType);
  }
  ...
  if (!coordSys) {
    if (true) {
      if (!allowNotFound) {
        (0,_util_log_js__rspack_import_1.error)(coordSysType + " cannot be found for" + (" " + targetModel.type + " (index: " + targetModel.componentIndex + ")."));
      }
    }
    return false;
  }
  if (kind === CoordinateSystemUsageKind.dataCoordSys) {
    if (true) {
      zrender_lib_core_util_js__rspack_import_0.assert(targetModel.mainType === 'series');
    }
...
var simpleCoordSysInjectionProvider = function (coordSysType, injectTargetModel) {
  var coordSysModel = injectTargetModel.getReferringComponents(coordSysType, _util_model_js__rspack_import_2.SINGLE_REFERRING).models[0];
  return coordSysModel && coordSysModel.coordinateSystem;
};
/* export default */ __webpack_exports__["default"] = (CoordinateSystemManager);

}),
29256: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var Global = __webpack_require__(91834);
...
var backwardCompat = __webpack_require__(19173);
...
var util_component = __webpack_require__(12616);
...
// EXTERNAL MODULE: ./node_modules/echarts/lib/core/lifecycle.js
var lifecycle = __webpack_require__(496);
...
var echarts_ECharts = /** @class */function (_super) {
  ...
  theme, opts) {
    ...
    if (true) {
      ...
      env["default"].hasGlobalWindow ? window : global;
      if (root) {
        defaultRenderer = (0,util.retrieve2)(root.__ECHARTS__DEFAULT__RENDERER__, defaultRenderer);
        defaultCoarsePointer = (0,util.retrieve2)(root.__ECHARTS__DEFAULT__COARSE_POINTER, defaultCoarsePointer);
        defaultUseDirtyRect = (0,util.retrieve2)(root.__ECHARTS__DEFAULT__USE_DIRTY_RECT__, defaultUseDirtyRect);
      }
    }
    if (opts.ssr) {
  ...
  ECharts.prototype.setOption = function (option, notMerge, lazyUpdate) {
    if (this[IN_MAIN_PROCESS_KEY]) {
      if (true) {
        (0,log.error)('`setOption` should not be called during main process.');
      }
      return;
    }
    if (this._disposed) {
  ...
  ECharts.prototype.setTheme = function (theme, opts) {
    if (this[IN_MAIN_PROCESS_KEY]) {
      if (true) {
        (0,log.error)('`setTheme` should not be called during main process.');
      }
      return;
    }
    if (this._disposed) {
  ...
  ECharts.prototype.getRenderedCanvas = function (opts) {
    if (true) {
      (0,log.deprecateReplaceLog)('getRenderedCanvas', 'renderToCanvas');
    }
      ...
      key.indexOf('Models') >= 0 && (0,util.each)(models, function (model) {
        ...
        if (coordSys && coordSys.containPoint) {
          ...
          if (view && view.containPoint) {
            ...
            if (true) {
              (0,log.warn)(key + ': ' + (view ? 'The found component do not support containPoint.' : 'No view mapping to the found component.'));
            }
          }
        } else {
          if (true) {
            (0,log.warn)(key + ': containPoint is not supported');
          }
        }
      }, this);
    }, this);
  ...
  ECharts.prototype.getVisual = function (finder, visualType) {
    ...
    if (true) {
      if (!seriesModel) {
        (0,log.warn)('There is no specified series model');
      }
    }
    var data = seriesModel.getData();
        ...
        if (params) {
          ...
          if (true) {
            ...
            if (!isGlobalOut && !(model && view)) {
              (0,log.warn)('model or view can not be found by params');
            }
          }
          params.event = e;
          params.type = eveName;
  ...
  ECharts.prototype.resize = function (opts) {
    if (this[IN_MAIN_PROCESS_KEY]) {
      if (true) {
        (0,log.error)('`resize` should not be called during main process.');
      }
      return;
    }
    if (this._disposed) {
  ...
  ECharts.prototype.showLoading = function (name, cfg) {
    ...
    if (!loadingEffects[name]) {
      if (true) {
        (0,log.warn)('Loading effects ' + name + ' not exists.');
      }
      return;
    }
  ...
  ECharts.prototype.updateLabelLayout = function () {
    lifecycle["default"].trigger('series:layoutlabels', this._model, this._api, {
  ...
  ECharts.prototype.appendData = function (params) {
    ...
    if (true) {
      (0,util.assert)(params.data && seriesModel);
    }
  ...
  ECharts.internalField = function () {
    ...
    prepareView = function (ecIns, isComponent) {
      ...
      function doPrepare(model) {
        ...
        if (!view) {
          ...
          if (true) {
            (0,util.assert)(Clazz, classType.sub + ' does not exist.');
          }
          view = new Clazz();
    ...
    updateMethods = {
      ...
      update: function (payload, updateParams) {
        ...
        lifecycle["default"].trigger('afterupdate', ecModel, api);
      },
      ...
      updateView: function (payload) {
        ...
        lifecycle["default"].trigger('afterupdate', ecModel, this._api);
      },
    ...
    function doConvertPixelImpl(ecIns, methodName, finder, value, opt) {
      ...
      if (true) {
        (0,log.warn)('No coordinate system that supports ' + methodName + ' found by the given finder.');
      }
    }
    ;
    ...
    renderSeries = function (ecIns, ecModel, api, payload, updateParams, dirtyMap) {
      ...
      // TODO progressive?
      lifecycle["default"].trigger('series:beforeupdate', ecModel, api, updateParams);
      var unfinished = false;
      ecModel.eachSeries(function (seriesModel) {
      ...
      lifecycle["default"].trigger('series:layoutlabels', ecModel, api, updateParams);
      // transition after label is layouted.
      lifecycle["default"].trigger('series:transition', ecModel, api, updateParams);
      ecModel.eachSeries(function (seriesModel) {
        var chartView = ecIns._chartsMap[seriesModel.__viewId];
      ...
      lifecycle["default"].trigger('series:afterupdate', ecModel, api, updateParams);
    };
...
function disposedWarning(id) {
  if (true) {
    (0,log.warn)('Instance ' + id + ' has been disposed');
  }
}
var actions = {};
/**
...
function init(dom, theme, opts) {
  ...
  if (isClient) {
    ...
    if (existInstance) {
      if (true) {
        (0,log.warn)('There is a chart instance already initialized on the dom.');
      }
      return existInstance;
    }
    if (true) {
      if ((0,util.isDom)(dom) && dom.nodeName.toUpperCase() !== 'CANVAS' && (!dom.clientWidth && (!opts || opts.width == null) || !dom.clientHeight && (!opts || opts.height == null))) {
        (0,log.warn)('Can\'t get DOM width or height. Please check ' + 'dom.clientWidth and dom.clientHeight. They should not be 0.' + 'For example, you may need to call this in the callback ' + 'of window.onload.');
      }
    }
  }
  ...
  enableConnect(chart);
  lifecycle["default"].trigger('afterinit', chart);
  return chart;
}
/**
 * @usage
...
function registerAction(arg0, arg1, action) {
  ...
  if ( true && connectionEventRevertMap[nonRefinedEventType]) {
    (0,log.error)(nonRefinedEventType + " must not be shared; use \"refineEvent\" if you intend to share an event name.");
  }
...
function normalizeRegister(targetList, priority, fn, defaultPriority, visualType) {
  ...
  if (true) {
    ...
    // Check duplicate
    (0,util.each)(targetList, function (wrap) {
      (0,util.assert)(wrap.__raw !== fn);
    });
  }
  // Already registered
...
function setCanvasCreator(creator) {
  if (true) {
    (0,log.deprecateLog)('setCanvasCreator is deprecated. Use setPlatformAPI({ createCanvas }) instead.');
  }
...
13976: (function (__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  getImpl: function() { return getImpl; },
  registerImpl: function() { return registerImpl; }
});
/* import */ var _util_log_js__rspack_import_0 = __webpack_require__(41025);
...
function registerImpl(name, impl) {
  if (true) {
    if (implsStore[name]) {
      (0,_util_log_js__rspack_import_0.error)("Already has an implementation of " + name + ".");
    }
  }
...
function getImpl(name) {
  if (true) {
    if (!implsStore[name]) {
      (0,_util_log_js__rspack_import_0.error)("Implementation of " + name + " doesn't exists.");
    }
  }
